        ...
        <div className="profile">
          ...
          <div className="subtitle subtitle-typed">
            <TypeWriterEffect
              ...
              startDelay={3000}
              cursorColor="#78cc6d"
              multiText={["Full-Stack Developer", "Web Developer", "Software Developer"]}
              multiTextDelay={3000}
              typeSpeed={50}
              multiTextLoop
            />
          ...
          <div className="social">
            <a
              className="link"
              href="https://www.facebook.com/Aditya12250/"
              rel="noreferrer"
              target="_blank"
              aria-label="facebook"
            >
            ...
            <a
              className="link"
              href="https://www.instagram.com/25verma_aditya12/"
              rel="noreferrer"
              target="_blank"
            ...
            <a
              className="link"
              href="https://www.linkedin.com/in/aditya-verma-5ab280194/"
              rel="noreferrer"
              target="_blank"
              aria-label="linkedin"
            >
            ...
            <a
              className="link"
              href="https://github.com/C0deWithAditya"
              rel="noreferrer"
              target="_blank"
              aria-label="Github"
            >
              <FaGithub data-aos="fade-up" data-aos-delay="300" />
            </a>
          </div>
          <div className="links">
            <a
