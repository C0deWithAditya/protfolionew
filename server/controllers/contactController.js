  ...
  try {
   ...
   // Configure options for sending confirmation emails to the sender and website owner
    ...
    options = {
      name: data.name,
      email: SMPT_MAIL,
      subject: "New Query from Your Portfolio Website",
      message_Content: `<p> Hi Aditya Verma, <br> You have received a new query from your Your Portfolio Website. The Sender Details are: <br> <b>Name : </b>${data.name} <br> <b>Email : </b> ${data.email} <br> <b>Message : </b> ${data.message} </p>`,
    };
